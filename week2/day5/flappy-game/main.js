...
const images = {
  bg: './assets/flappy-bg.png',
  flappy: './assets/flappy.png',
  logo: './assets/flappy-logo.png',
  pipeTop: './assets/flappy-pipe-top.png',
  pipeBot: './assets/flappy-pipe-bot.png',
}
...
function loadScreen() {
  ...
  ctx.fillText('Press enter to start the game', 100, 300)
}
